...
class GenericAgentLRDecay(GenericAgent):
    ...
    def train(self):
        scheduler = optim.lr_scheduler.ReduceLROnPlateau(self.optimizer,factor=self.config.lr_scheduler_factor,mode=self.config.lr_scheduler_mode,patience=10,min_lr=self.config.min_lr)
